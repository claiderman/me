...
# Proyecto del portafolio multilenguaje

Este repositorio contiene el portafolio profesional multilenguaje con rutas estáticas para ES y EN. Está desarrollado con Astro y publicado bajo la base path `/me`.
...
## Comportamiento de idioma y redirección

La página inicial detecta el locale en este orden:

1. `localStorage.locale`
2. idioma del navegador
3. fallback: `es`

Luego redirige a la ruta correspondiente:
...
Los CVs deben mantenerse actualizados en estos archivos:
...
La descarga del CV usa el idioma actual para elegir la hoja de vida correcta.
...
Este proyecto está preparado para GitHub Pages con la configuración:
...
Se mantiene el contenido personal original y se añade la documentación técnica del sitio multilenguaje para asegurar que la navegación y los archivos PDF correspondan correctamente a España/ES y al inglés/EN.
